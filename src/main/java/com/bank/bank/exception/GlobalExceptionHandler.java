...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex, HttpServletRequest request) {
        StringBuilder errorMessage = new StringBuilder("Validatie mislukt: ");
    ...
    public ResponseEntity<ErrorResponse> handleAccountAlreadyExistException(AccountAlreadyExistException ex, HttpServletRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                ex.getErrorCode().getMessage(),
                ex.getErrorCode().getStatus().value(),
                request.getRequestURI()
        );
        log.error("occur AccountAlreadyExistException:" + errorResponse);
